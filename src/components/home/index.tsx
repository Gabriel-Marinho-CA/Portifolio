      ...
      <div className={styles.home} id="inicio">
        <Container className={styles.homeContainer}>
            <div className={styles.icons}>
              ...
              <Link href="https://github.com/Gabriel-Marinho-CA" className={styles.linkIcon} target={"_blank"}>
                <span className={styles.linkIcon}>
            ...
            <div className={styles.description}> 
              <p className={styles.title}>Olá, me chamo <span className={styles.color}>Gabriel</span></p>
